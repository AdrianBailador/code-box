...
// src={data.sprites.other.dream_world.front_default} Esta es una imagen del Pokémon. La URL de la imagen se obtiene de data.sprites.other.dream_world.front_default.
// se ejecuta en el servidor antes de renderizar la página. Obtiene el nombre del Pokémon de los parámetros de la ruta (context.params), 
// hace una solicitud a la API de Pokémon para obtener datos sobre ese Pokémon, y luego devuelve esos datos como props para el componente de la página.
