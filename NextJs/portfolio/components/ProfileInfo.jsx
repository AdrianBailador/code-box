  ...
  return (
    <div className={'flex items-center justify-start mt-5'} >
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <div style={{ borderRadius: '50%', overflow: 'hidden', marginRight: '1rem', border:'3px solid green', padding:'.3rem' }}>
        ...
        <div className={'profile-info flex flex-col gap-2'}>
          <div className="info">
            ...
            <p className={'italic text-gray-600'}>Software Engineer & FullStack Developer</p>
          </div>
          <SocialIcons/>
